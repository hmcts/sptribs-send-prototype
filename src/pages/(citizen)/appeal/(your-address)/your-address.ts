...
import { cy, en } from "./your-address.i18n.js";

/**
 * The appellant's address — SEND35 question 2.2.
 */
const BACK = "/appeal/your-contact-details";
...
function render(res: Response, values: Record<string, unknown>, errors: Record<string, string>): void {
  res.render("your-address", { en, cy, values, errors, backHref: BACK });
}
